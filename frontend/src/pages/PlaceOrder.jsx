...
const PlaceOrder = () => {
  ...
  return (
    ...
    {/* left side */}
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          <input required onChange={onChangeHandler} name='firstName' value={formData.firstName} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='text' placeholder='Name'/>
    ...
    <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
        <div className={`min-w-3.5 h-3.5 border rounded-full ${method === 'stripe' ? 'bg-orange-400' : ''}`}>  </div>
    ...
    <div onClick={() => setMethod('razorpay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
        <div className={`min-w-3.5 h-3.5 border rounded-full ${method === 'razorpay' ? 'bg-orange-400' : ''}`}></div>
    ...
    <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
        <div className={`min-w-3.5 h-3.5 border rounded-full ${method === 'cod' ? 'bg-orange-400' : ''}`}></div>
