...
const Navbar = ({ setToken }) => {
  return (
    <div className='flex items-center py-2 px-[4%] justify-between'>
      ...
      <button onClick={() => setToken('')} className='bg-orange-500 text-white px-5 py-2 sm:px-7 rounded-full text-xs sm:text-sm transition-transform transform hover:scale-110'>
        Logout
      </button>
    </div>
  );
